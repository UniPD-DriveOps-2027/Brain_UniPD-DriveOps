...
if not EVENT_SETTINGS:
    ...
    if RANDOM_START:
        STARTING_COORDS = [0.00, 0.00]    # We need to read from GPS - BFMC2024
        ...
        CHECKPOINTS = [472, 99, 154, 192, 434, 500, 133, 91, 466, 323, END_NODE_RANDOM] # Techinical Run BFMC_2024 route ONLY RIGHT ROUNDABOUT
        OVERTAKE_COUNTER = [3, 5, 17, 18]
        ...
        if SPEED_CHALLENGE:
            ...
            CHECKPOINTS = [472, 323, 149, 91, 466, 434, 500, 125, 154, END_NODE] # Techinical Run BFMC_2024 route ONLY RIGHT ROUNDABOUT
