#!/usr/bin/python3
# Purpose: Compute longitudinal speed control from desired and measured motion.
# Inputs: Desired speed, measured speed, and controller timing/state.
# Outputs: Speed or acceleration command for the vehicle interface.
...
class Filter():
    ...
    # UNUSED: Filter.filter has no production caller.
    ...
    # UNUSED: Filter.update_params has no production caller.
