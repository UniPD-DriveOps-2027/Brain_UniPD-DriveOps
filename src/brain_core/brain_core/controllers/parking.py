#!/usr/bin/python3
# Purpose: Execute parking and manoeuvre command sequences.
# Inputs: AutomobileData command interface, manoeuvre type, and measured motion.
# Outputs: Timed speed and steering commands sent to the vehicle.
...
class Maneuvers():
    ...
    # UNUSED: Maneuvers.parallel_parking has no production caller.
