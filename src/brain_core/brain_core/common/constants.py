#!/usr/bin/python3
# Purpose: Define shared Brain state, event, sign, speed, and control constants.
# Inputs: Imported configuration values; no runtime data stream.
# Outputs: Named constants consumed by planning, perception, controllers, and the state machine.
