#!/usr/bin/env python3
# Purpose: Bridge UDP semaphore packets into typed ROS 2 topics.
# Inputs: Network packets, device configuration, and semaphore IDs.
# Outputs: brain_interfaces/Semaphore messages.
...
from brain_interfaces.msg import Semaphore, Vehicles
