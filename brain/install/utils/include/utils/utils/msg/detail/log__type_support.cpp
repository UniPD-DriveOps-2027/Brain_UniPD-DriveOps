...
{
  new (message_memory) utils::msg::Log(_init);
}

void Log_fini_function(void * message_memory)
{
  auto typed_message = static_cast<utils::msg::Log *>(message_memory);
  typed_message->~Log();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Log_message_member_array[2] = {
  {
    "level",  // name
    ...
    offsetof(utils::msg::Log, level),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(utils::msg::Log, msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<utils::msg::Log>()
{
  return &::utils::msg::rosidl_typesupport_introspection_cpp::Log_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, utils, msg, Log)() {
  return &::utils::msg::rosidl_typesupport_introspection_cpp::Log_message_type_support_handle;
}
