...
#ifndef UTILS__MSG__DETAIL__VEHICLES__TYPE_SUPPORT_H_
#define UTILS__MSG__DETAIL__VEHICLES__TYPE_SUPPORT_H_
...
#endif  // UTILS__MSG__DETAIL__VEHICLES__TYPE_SUPPORT_H_
