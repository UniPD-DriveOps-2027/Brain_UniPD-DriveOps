...
#ifndef UTILS__SRV__DETAIL__REQUEST_PARAM__FUNCTIONS_H_
#define UTILS__SRV__DETAIL__REQUEST_PARAM__FUNCTIONS_H_
...
/// Initialize srv/RequestParam message.
/**
 ...
 * )) before or use
 * utils__srv__RequestParam_Request__create()
...
/// Finalize srv/RequestParam message.
/**
...
/// Create srv/RequestParam message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * utils__srv__RequestParam_Request__init().
...
/// Destroy srv/RequestParam message.
/**
 * It calls
 * utils__srv__RequestParam_Request__fini()
...
/// Check for srv/RequestParam message equality.
/**
...
/// Copy a srv/RequestParam message.
/**
...
/// Initialize array of srv/RequestParam messages.
/**
...
/// Finalize array of srv/RequestParam messages.
/**
 * It calls
 * utils__srv__RequestParam_Request__fini()
...
/// Create array of srv/RequestParam messages.
/**
 * It allocates the memory for the array and calls
 * utils__srv__RequestParam_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RequestParam messages.
/**
 * It calls
 * utils__srv__RequestParam_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RequestParam message array equality.
/**
...
/// Copy an array of srv/RequestParam messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * utils__srv__RequestParam_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_utils
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * utils__srv__RequestParam_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_utils
...
/**
 * It calls
 * utils__srv__RequestParam_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_utils
...
/**
 * It allocates the memory for the array and calls
 * utils__srv__RequestParam_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_utils
...
/**
 * It calls
 * utils__srv__RequestParam_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * utils__srv__RequestParam_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_utils
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * utils__srv__RequestParam_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_utils
...
/**
 * It calls
 * utils__srv__RequestParam_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_utils
...
/**
 * It allocates the memory for the array and calls
 * utils__srv__RequestParam_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_utils
...
/**
 * It calls
 * utils__srv__RequestParam_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UTILS__SRV__DETAIL__REQUEST_PARAM__FUNCTIONS_H_
