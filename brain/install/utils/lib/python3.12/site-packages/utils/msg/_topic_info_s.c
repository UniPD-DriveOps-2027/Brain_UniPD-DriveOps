...
bool utils__msg__topic_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("utils.msg._topic_info.TopicInfo", full_classname_dest, 31) == 0);
  }
  utils__msg__TopicInfo * ros_message = _ros_message;
  {  // topic_id
    ...
    ros_message->topic_id = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // topic_name
  ...
  {  // buffer_size
    ...
    assert(PyLong_Check(field));
    ros_message->buffer_size = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of TopicInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("utils.msg._topic_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TopicInfo");
  ...
  {  // buffer_size
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->buffer_size);
    {
