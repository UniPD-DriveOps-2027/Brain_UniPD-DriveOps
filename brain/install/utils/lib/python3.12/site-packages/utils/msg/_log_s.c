...
bool utils__msg__log__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    char full_classname_dest[19];
    {
    ...
    assert(strncmp("utils.msg._log.Log", full_classname_dest, 18) == 0);
  }
  utils__msg__Log * ros_message = _ros_message;
  {  // level
...
PyObject * utils__msg__log__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("utils.msg._log");
