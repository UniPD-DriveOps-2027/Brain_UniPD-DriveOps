...
from src.templates2025.workerprocess import WorkerProcess
from src.data2025.Semaphores.threads.threadSemaphores import (
    threadSemaphores,
)
...
if __name__ == "__main__":
    ...
    logger = logging.getLogger("SemaphoresProcess")
    ...
    allProcesses = list()
    process = processSemaphores(queueList, logger)  # Pass the logger here
    process.start()
