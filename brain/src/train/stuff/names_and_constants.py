...
LENGTH = 0.46  			            # [m]       car body length 
WIDTH = 0.19   			            # [m]       car body width 0.18, 0.2
...
EVENT_TYPES = [INTERSECTION_STOP_EVENT, INTERSECTION_TRAFFIC_LIGHT_EVENT, INTERSECTION_PRIORITY_EVENT
                  ,ROUNDABOUT_EVENT, CROSSWALK_EVENT, PARKING_EVENT, HIGHWAY_EXIT_EVENT]
...
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
LIGHT_BLUE = (200, 150, 0)
DLIGHT_BLUE = (133, 100, 0) #(200, 200, 0)
