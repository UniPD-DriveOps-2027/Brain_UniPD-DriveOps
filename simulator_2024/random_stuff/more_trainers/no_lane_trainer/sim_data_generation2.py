...
from no_lane_trainer.helper_functions2022 import *
...
file_name = 'no_lane_trainer/saved_tests/sim_ds_'

SHOW_FRAMES = False
TARGET_FPS = 30

spath = np.load('no_lane_trainer/no_lane_path_precise.npy').T # load spath from file
#add 2 to all x
spath[:,0] += 2.5
spath[:,1] += 2.5
...
map = cv.imread('src/models_pkg/track_trainer/materials/textures/test_VerySmall_2024.png')
