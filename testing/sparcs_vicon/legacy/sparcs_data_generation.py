#!/usr/bin/python3
# Purpose: Generate legacy SPARCS localisation/path test data.
# Inputs: Vicon/network measurements and track configuration.
# Outputs: Recorded coordinate datasets and diagnostic output.
