#!/usr/bin/python3
# Purpose: Run the legacy Raspberry Pi side of SPARCS localisation tests.
# Inputs: Network/Vicon packets and Pi configuration.
# Outputs: Localisation messages and recorded test telemetry.
