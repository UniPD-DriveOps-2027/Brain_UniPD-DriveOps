# Purpose: Create legacy SPARCS reference paths from recorded coordinates.
# Inputs: Recorded coordinate samples and path-generation parameters.
# Outputs: NumPy path arrays for Vicon/SPARCS tests.
